...
```{r, echo = TRUE, eval = TRUE}
dbs <- c("GO_Molecular_Function_2015", "GO_Cellular_Component_2015", "GO_Biological_Process_2015", "dbGaP")
enriched <- enrichr(c("RUNX1", "GFI1", "GFI1B", "SPI1", "GATA1", "KDR", "PML"), dbs)
```
